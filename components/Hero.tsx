      ...
      <div className="md:grid md:grid-cols-2 md:items-center md:gap-10">
        ...
        <div className="order-2">
          ...
          >
            <h1
              id="hero-heading"
              className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl xl:text-6xl leading-tight tracking-tight text-center md:text-left mb-4"
            >
              <strong 
              ...
              >
                <span className="block">Veterinary Mobile</span>
                <span className="block">Ultrasound Service</span>
              </strong>
            </h1>
